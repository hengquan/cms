...
public class ControllerBase {
	 ...
	 * SimpleDateFormat(Config.getDateFormatDate());
	...
	public String toJsonStrWithExcludeProperties(Object value,
		...
		String result = null;
		try {
			result = jsonMapper.toJsonStrWithExcludeProperties(value,
					properties2Exclude);
			result = escapeHtml(result);
		} catch (JsonGenerationException e) {
			e.printStackTrace();
	...
	public String toListJson(int totalCount, List<Object> lst,
			String[] listfields) {
	...
	public static Map<String, Map<String, Object>> json2Map(String json) {
		if(StringUtils.trimToEmpty(json).equals(""))return null;
