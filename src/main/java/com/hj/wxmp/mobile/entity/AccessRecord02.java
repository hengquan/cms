...
public class AccessRecord02 {
    ...
    public void setVisitorrefsdesc(String visitorrefsdesc) {
        this.visitorrefsdesc = visitorrefsdesc == null ? null : visitorrefsdesc.trim();
    }
    ...
    public void setFaultdescn(String faultdescn) {
        this.faultdescn = faultdescn == null ? null : faultdescn.trim();
    }
    ...
    public void setVisitorrefs(String visitorrefs) {
        this.visitorrefs = visitorrefs == null ? null : visitorrefs.trim();
    }
    ...
    public void setCapitalprepsection(String capitalprepsection) {
        this.capitalprepsection = capitalprepsection == null ? null : capitalprepsection.trim();
    }
