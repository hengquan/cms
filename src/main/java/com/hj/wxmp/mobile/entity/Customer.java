...
public class Customer {
	...
	public void setCaptilprepsection(String captilprepsection) {
		this.captilprepsection = captilprepsection;
	}
	...
	public void setHouseregitype(String houseregitype) {
		this.houseregitype = houseregitype;
	}
