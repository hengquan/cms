...
public class Base64Utils {
	...
	public static String encodeObject(java.io.Serializable serializableObject,
		...
		try {
			...
			b64os = new Base64Utils.OutputStream(baos, Base64Utils.ENCODE, breakLines);
	...
	private static String appendRandomString(){		 
		return appendRandomString(64);
	}
	
	private static String appendRandomString(int len){
	...
	public static String encodeBaseString(String s){
		if(s==null || "".equals(s) || "null".equals(s)){
			return "";
		}
		
		String str = encodeString(s);
		str = str.substring(0,1)+appendRandomString()+str.substring(1);
		return str;
	}
	
	public static String decodeToBaseString(String s){
		if(s==null || "".equals(s) || "null".equals(s) || s.length()<66){
			return "";
		}
		
		s = s.substring(0,1)+s.substring(65);
		return decodeToString(s);
	}
	
	public static String encodeFixLenString(String s){
		if(s==null || "".equals(s) || "null".equals(s)){
			return "";
		}
		...
		String fixStr = "He";
		String str = encodeString(s);
		str = str.substring(0,1)+fixStr+str.substring(1);
		return str;
	}
	
	public static String decodeToFixLenString(String s){
		if(s==null || "".equals(s) || "null".equals(s)){
			return "";
		}
