var Script = function() {
	...
	var addBtn = '<div class="btn-group js-btn js-add"><a href="javascript:doAdd();" class="btn mini btn-white"><i class="icon-plus"></i></a></div>&nbsp;&nbsp;';
			...
			.dataTable(
					{
						...
						"oLanguage" : {
							"sLengthMenu" : refBtn + addBtn + delBtn
									+ "_MENU_ ",
							"oPaginate" : {
								"sPrevious" : "Prev",
								"sNext" : "Next"
