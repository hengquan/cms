...
function loadPage() {
  ...
  function fillList(data) {
    var _updateUrl=_URL_BASE+"/wxfront/record03/record03Input.html?type=update";
    var _viewUrl=_URL_BASE+"/wxfront/record03/record03View.html";
    ...
    for (var i=0; i<data.length; i++) {
      ...
      if (phone) newPhone="<span><a href='tel:"+newPhone+"'>"+newPhone+"</a></span><br/>";
...
function search() {
  ...
  window.location.href=_URL_BASE+"/wxfront/record03/record03Search.html?searchStr="+encodeURIComponent(_searchStr);
}