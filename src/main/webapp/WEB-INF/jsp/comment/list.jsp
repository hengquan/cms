							...
							<div class="modal-body">
								<form class="form-horizontal" role="form" id="itemForm"
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" value="${anwProduct.productName}" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-1 control-label pd-r5">商品价格<font
											style="color: red;"></font></label>
										<div class="col-lg-4">
											<input type="text" class="form-control" value="${anwProduct.price}" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-1 control-label pd-r5">商品运费<font
											style="color: red;"></font></label>
										<div class="col-lg-4">
											<input type="text" class="form-control" value="${anwProduct.freight}" />
										</div>
									</div>
									<div class="form-group">
										<label class="col-lg-1 control-label pd-r5">商品图片<font
											style="color: red;"></font></label>
										<div class="col-lg-10">
											<c:if test="${!empty anwProduct.productImg}">
												<img src="${anwProduct.productImg}" alt="..." class="img-thumbnail" width="140" height="140" /> 
											</c:if>
											<c:if test="${empty anwProduct.productImg}">
							...
							<table class="table table-striped border-top" id="sample_1">
								<thead>
									<tr>
										...
										<th class="hidden-phone">星数</th>
										<th class="hidden-phone">创建时间</th>
									</tr>
								</thead>
								<tbody id="theTbody">
									<c:forEach items="${comments}" var="u" varStatus="s">
										<tr class="odd gradeX theTr">
											...
											<td class="hidden-phone">${u.msg}</td>
											<td>${u.star}</td>
