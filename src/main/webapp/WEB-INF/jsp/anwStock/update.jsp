								...
								<tbody id="theTbody">
									<c:forEach items="${userList}" var="u" varStatus="s">
										<tr class="odd gradeX theTr">
											...
											<td class="hidden-phone">${u.product_name}</td>
											...
											<td>
												<button type="button" class="btn btn-primary" onclick="updateMsg('${u.id}','${u.delivery_man}','${u.mobile}','${u.stock}','${u.cause}')">确认收货</button>
											</td>
										</tr>
									</c:forEach>
								</tbody>
