...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">商品规格管理</header>
							<form action="${appRoot}/anwStandard/list" method="post"
								...
								<div
									...
									<input type="text" class="btn"
										...
										placeholder="请输入商品规格" name="userName1" value="${mingzi }"><span>
								...
								<thead>
									<tr>
										<th style="width: 8px;"><input type="checkbox" name="box"
											...
											value="" /></th>
										<th class="hidden-phone">规格名称</th>
										<th class="hidden-phone">操作</th>
									</tr>
								</thead>
								<tbody id="theTbody">
									<c:forEach items="${anwStandards}" var="u" varStatus="s">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="modal-title">添加规格</h4>
				</div>
				<div class="modal-body">
					<form action="${appRoot}/anwStandard/add" method="post"
						class="form-horizontal" enctype="multipart/form-data" role="form"
						id="addMessage" name="itemForm">
						<input type="hidden" name="editId" id="editId">
						<div class="form-group">
							<label class="col-lg-2 control-label pd-r5">规格名称<font
								style="color: red;"></font></label>
							<div class="col-lg-10">
								<input type="text" class="form-control" id="standardName"
									name="standardName" maxlength="10">
							</div>
						</div>
						<div class="form-group">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="modal-title">修改规格</h4>
				</div>
				<div class="modal-body">
					<form action="${appRoot}/anwStandard/edit" method="post"
						class="form-horizontal" enctype="multipart/form-data" role="form"
						id="updateMessage" name="itemForm">
						<input type="hidden" name="standardId1" id="standardId1">
						<div class="form-group">
							<label class="col-lg-2 control-label pd-r5">类型名称<font
								style="color: red;"></font></label>
							<div class="col-lg-10">
								<input type="text" class="form-control" id="standardName1"
									name="standardName1">
							</div>
						</div>
						<div class="form-group">
	...
	<form action="${appRoot}/anwStandard/del" method="post"
	...
	<script type="text/javascript">
		...
		function submitUpdateData() {
			var standardName = $("#standardName1").val();
			if (standardName == '' || standardName == undefined) {
				windowShow("规格名称不允许为空！", "");
				return;
			}
