							...
							<div class="modal-body">
								<form action="${appRoot}/anwProduct/add" method="post" class="form-horizontal"  enctype="multipart/form-data"  role="form" id="addMessage" name="itemForm">
									...
									<div class="form-group">
										...
										<div class="col-lg-4">
											<input type="text" class="form-control" id="productName" name="productName" maxlength="10" >
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label class="col-lg-1 control-label pd-r5">商品详情<font
											style="color: red;"></font></label>
										<div class="col-lg-10">
											<textarea name="productDetails" class="az-txtarea" id="content" style="width: 100%; height: 100px;font-size: 14px;"></textarea>
								 	  	</div>
									</div>
									<div class="form-group pic_upload clearfix" style="width: 100%">
										<label class="col-lg-1 control-label pd-r5">图片-封面<font
											style="color: red;"></font></label>
										<div class="col-lg-10">
									...
									<div class="form-group pic_upload clearfix" style="width: 100%">
										<label for="inputPassword" class="col-sm-1 control-label tr">图片-轮播</label>
										<div class="col-sm-10">
											<ul id="hiddenImgUrl">
