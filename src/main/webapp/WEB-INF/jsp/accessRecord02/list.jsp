...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">复访记录审核</header>
								<form action="${appRoot}/accessRecord/recheckRecord" method="post" id="selectCheckMessage">
	...
	<form action="${appRoot}/accessRecord/recheckRecordDel" method="post" id="deleForm" name="deleForm">
