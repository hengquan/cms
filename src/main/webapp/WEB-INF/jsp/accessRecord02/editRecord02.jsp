					...
					<div
						...
						<form action="http://kylindpc.cn/zz_user.php" method="post"
							...
							<table id="orderinfo" cellpadding="0" cellspacing="0"
								...
								<tbody>
									<tr style="">
										<td style="width: 300px;">姓名：贺渝</td>
										<td style="width: 300px;">性别：女</td>
										<td style="width: 320px">置业顾问：贺渝测试</td>
									</tr>

									<tr>
										<td style="width: 320px">联系方式：13810052031</td>
										<td style="width: 220px">
											本次到访时间：
											<input type="date" name="daofang_time" value="2017-07-15">
										</td>
										<td style="width: 280px">
										首次到访时间：
											<input type="date" name="daofang_time" value="2017-06-15">
										</td>
									</tr>
									...
									<tr>
										<td colspan="3">现居住社区名称：<input type="text"
											style="width: 9rem" name="xian_shequ">
										</td>
									</tr>
									...
									<tr>
										<td colspan="3">贷款记录：<select name="daikuan">
									...
									<tr>
										<td>全职太太：<input name="quanzhitaitai" type="radio"
											value="是" style="width: 1rem">是 <input
											name="quanzhitaitai" type="radio" value="否"
											style="width: 1rem">否 <input name="quanzhitaitai"
											type="radio" value="无法了解" style="width: 1rem"><span
											style="color: red">无解</span>
										</td>
										<td>有保姆：<input name="baomu" type="radio" value="是"
											style="width: 1rem">是 <input name="baomu"
											type="radio" value="否" style="width: 1rem">否 <input
											name="baomu" type="radio" value="无法了解" style="width: 1rem"><span
											style="color: red">无解</span>
										</td>
										<td>有宠物：<input name="chongwu" type="radio" value="是"
											style="width: 1rem">是 <input name="chongwu"
											type="radio" value="否" style="width: 1rem">否 <input
											name="chongwu" type="radio" value="无法了解" style="width: 1rem"><span
											style="color: red">无解</span>
										</td>
									</tr>

									<tr>
										<td>国际教育意愿：<input name="guojijiaoyu" type="radio"
											value="是" style="width: 1rem">是 <input
											name="guojijiaoyu" type="radio" value="否" style="width: 1rem">否
											<input name="guojijiaoyu" type="radio" value="无法了解"
											style="width: 1rem"><span style="color: red">无解</span>
										</td>
										<td>子女海外经历：<input name="zinvhaiwai" type="radio"
											value="是" style="width: 1rem">是 <input
											name="zinvhaiwai" type="radio" value="否" style="width: 1rem">否
											<input name="zinvhaiwai" type="radio" value="无法了解"
											style="width: 1rem"><span style="color: red">无解</span>
										</td>
										<td>业主海外经历：<input name="yezhuhaiwai" type="radio"
											value="是" style="width: 1rem">是 <input
											name="yezhuhaiwai" type="radio" value="否" style="width: 1rem">否
											<input name="yezhuhaiwai" type="radio" value="无法了解"
											style="width: 1rem"><span style="color: red">无解</span>
										</td>
									</tr>
									...
									<tr>
										<td colspan="3">驾车总价：<input name="chejia" type="radio"
											value="30万以下" style="width: 1rem">30万以下 <input
											name="chejia" type="radio" value="30-50万" style="width: 1rem">30-50万
											<input name="chejia" type="radio" value="50-100万"
											style="width: 1rem">50-100万 <input name="chejia"
											type="radio" value="100-200万" style="width: 1rem">100-200万
											<input name="chejia" type="radio" value="200万以上"
											style="width: 1rem">200万以上 <input name="chejia"
											type="radio" value="200万以上" style="width: 1rem">200万以上
											<input name="chejia" type="radio" value="200-300万"
											style="width: 1rem">200-300万<br> <input
											name="chejia" type="radio" value="300-500万、"
											style="width: 1rem; margin-left: 95px">300-500万 <input
											name="chejia" type="radio" value="500万以上" style="width: 1rem">500万以上
											<input name="chejia" type="radio" value="无法了解"
											style="width: 1rem"><span style="color: red">无法了解</span>
										</td>
									</tr>

									<tr>
										<td colspan="1">关注的公众微信号：<input type="text"
											style="width: 7rem" name="gongzhong1"><input
											type="text" style="width: 7rem; display: none"
											name="gongzhong2"><input type="text"
											style="width: 7rem; display: none" name="gongzhong3">
										</td>

										<td colspan="2">常用APP(除微信外三个)：<input type="text"
											style="width: 6rem" name="app1"><input type="text"
											style="width: 6rem; display: none" name="app2"><input
											type="text" style="width: 6rem; display: none" name="app3">
										</td>
									</tr>

									<tr>
										<td colspan="3">您的业余爱好：<input name="aihao[]"
											type="checkbox" value="运动" style="width: 1rem">运动 <input
											name="aihao[]" type="checkbox" value="养生" style="width: 1rem">养生
											<input name="aihao[]" type="checkbox" value="步行"
											style="width: 1rem">美容 <input name="aihao[]"
											type="checkbox" value="阅读" style="width: 1rem">阅读 <input
											name="aihao[]" type="checkbox" value="理财" style="width: 1rem">理财
											<input name="aihao[]" type="checkbox" value="艺术"
											style="width: 1rem">艺术 <input name="aihao[]"
											type="checkbox" value="茶道" style="width: 1rem">茶道 <input
											name="aihao[]" type="checkbox" value="收藏" style="width: 1rem">收藏
											<input name="aihao[]" type="checkbox" value="购物"
											style="width: 1rem">购物<br> <input name="aihao[]"
											type="checkbox" value="美食"
											style="width: 1rem; margin-left: 123px">美食 <input
											name="aihao[]" type="checkbox" value="园艺" style="width: 1rem">园艺
											<input name="aihao[]" type="checkbox" value="社交"
											style="width: 1rem">社交 <input name="aihao[]"
											type="checkbox" value="时尚" style="width: 1rem">时尚 <input
											name="aihao[]" type="checkbox" value="旅行" style="width: 1rem">旅行
											<input name="aihao[]" type="checkbox" value="教育"
											style="width: 1rem">教育 <input name="aihao[]"
											type="checkbox" value="慈善" style="width: 1rem">慈善 <input
											name="aihao[]" type="checkbox" value="无法了解"
											style="width: 1rem"><span style="color: red">无法了解</span>
										</td>
									</tr>

									<tr>
										<td colspan="3">您对本案的抗拒点：<input name="kangju[]"
											type="checkbox" value="位置" style="width: 1rem">位置 <input
											name="kangju[]" type="checkbox" value="产品类型"
											style="width: 1rem">产品类型 <input name="kangju[]"
											type="checkbox" value="交通" style="width: 1rem">交通 <input
											name="kangju[]" type="checkbox" value="区域环境"
											style="width: 1rem">区域环境 <input name="kangju[]"
											type="checkbox" value="价格" style="width: 1rem">价格 <input
											name="kangju[]" type="checkbox" value="户型"
											style="width: 1rem">户型 <input name="kangju[]"
											type="checkbox" value="花园面积" style="width: 1rem">花园面积<br>
											<input name="kangju[]" type="checkbox" value="园林环境"
											style="width: 1rem; margin-left: 151px">园林环境 <input
											name="kangju[]" type="checkbox" value="科技设备"
											style="width: 1rem">科技设备 <input name="kangju[]"
											type="checkbox" value="交房时间" style="width: 1rem">交房时间
											<input name="kangju[]" type="checkbox" value="社区配套"
											style="width: 1rem">社区配套 <input name="kangju[]"
											type="checkbox" value="交房时间" style="width: 1rem">交房时间
											<input name="kangju[]" type="checkbox" value="物业服务"
											style="width: 1rem">物业服务 <input name="kangju[]"
											type="checkbox" value="教育环境 " style="width: 1rem">教育环境<br>
											<input name="kangju[]" type="checkbox" value="开发品牌"
											style="width: 1rem; margin-left: 151px">开发品牌 <input
											name="kangju[]" type="checkbox" value="增值潜力"
											style="width: 1rem">增值潜力 <input name="kangju[]"
									...
									<tr>
										<td colspan="3">您喜欢参加的活动：<input name="huodong[]"
											type="checkbox" value="家庭教育" style="width: 1rem">家庭教育
											<input name="huodong[]" type="checkbox" value="国际学校教育"
											style="width: 1rem">国际学校教育 <input name="huodong[]"
											type="checkbox" value="亲子活动" style="width: 1rem">亲子活动
											<input name="huodong[]" type="checkbox" value="文化艺术"
											style="width: 1rem">文化艺术 <input name="huodong[]"
											type="checkbox" value="美食品鉴" style="width: 1rem">美食品鉴<br>
											<input name="huodong[]" type="checkbox" value="户外运动"
											style="width: 1rem; margin-left: 151px">户外运动 <input
											name="huodong[]" type="checkbox" value="养生保健"
											style="width: 1rem">养生保健 <input name="huodong[]"
											type="checkbox" value="理财规划" style="width: 1rem">理财规划
											<input name="huodong[]" type="checkbox" value="书刊杂志"
											style="width: 1rem">书刊杂志 <input name="huodong[]"
											type="checkbox" value="琴棋书画" style="width: 1rem">琴棋书画
											<input name="huodong[]" type="checkbox" value="无法了解"
											style="width: 1rem"><span style="color: red">无法了解</span>
										</td>
									</tr>

									<tr>
										<td colspan="3">可参加业主活动时间：<span style="margin-left: 20px">周一到周五（</span>
											<input name="huodongtime[]" type="checkbox"
											value="周一到周五上午9-11点" style="width: 1rem; margin-left: 5px">上午9-11点
											<input name="huodongtime[]" type="checkbox"
											value="周一到周五下午2-5点" style="width: 1rem">下午2-5点 <input
											name="huodongtime[]" type="checkbox" value="周一到周五晚上6-9点"
											style="width: 1rem">晚上6-9点 ）<br> <span
											style="margin-left: 160px"> 周六到周日（</span> <input
											name="huodongtime[]" type="checkbox" value="周六到周日上午9-11点"
											style="width: 1rem; margin-left: 5px">上午9-11点 <input
											name="huodongtime[]" type="checkbox" value="周六到周日下午2-5点"
											style="width: 1rem">下午2-5点 <input
											name="huodongtime[]" type="checkbox" value="周六到周日晚上6-9点"
											style="width: 1rem">晚上6-9点 ） <input
											name="huodongtime[]" type="checkbox" value="无法了解"
											style="width: 1rem"><span style="color: red">无法了解</span>
										</td>
									</tr>
									...
									<tr>
										<td colspan="3">来访人数：<input name="renshu" type="radio"
											value="一人" style="width: 1rem" onclick="yiren()">一人 <input
											name="renshu" type="radio" value="两人" style="width: 1rem"
											onclick="yirenxianshi()">两人 <input name="renshu"
											type="radio" value="三人" style="width: 1rem"
											onclick="yirenxianshi()">三人 <input name="renshu"
											type="radio" value="四人" style="width: 1rem"
											onclick="yirenxianshi()">四人 <input name="renshu"
											type="radio" value="五人及以上" style="width: 1rem"
											onclick="yirenxianshi()">五人及以上
										</td>
									</tr>

									<tr>
										<td colspan="3"><span id="box4" style="display: block;">来访人之间关系：<input
												name="guanxi[]" type="checkbox" value="夫妻"
												style="width: 1rem">夫妻 <input name="guanxi[]"
												type="checkbox" value="与父母同行" style="width: 1rem">与父母同行
												<input name="guanxi[]" type="checkbox" value="与子女同行"
												style="width: 1rem">与子女同行 <input name="guanxi[]"
												type="checkbox" value="朋友" style="width: 1rem">朋友 <input
												name="guanxi[]" type="checkbox" value="同事"
												style="width: 1rem">同事
										</span></td>
									</tr>
