		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">每周抽奖管理</header>
...
<%-- 											<c:choose> --%>
<%-- 												<c:when test="${info.isvalidate == 1}"> --%>
<!-- 													<td class="hidden-phone">有效</td> -->
<%-- 												</c:when> --%>
<%-- 												<c:otherwise> --%>
<!-- 													<td class="hidden-phone">无效</td> -->
<%-- 												</c:otherwise> --%>
<%-- 											</c:choose> --%>
