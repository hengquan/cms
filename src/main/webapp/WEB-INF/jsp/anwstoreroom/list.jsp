...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">库存站点管理</header>
							<form action="${appRoot}/storeroom/list" method="post"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${appRoot}/storeroom/add" method="post"
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" class="form-control" id="storeroomName"
									name="storeroomName" maxlength="10">
							</div>
						</div>
						<div class="form-group">
	...
	<div class="modal fade" id="editProblemType" tabindex="-1"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${appRoot}/storeroom/edit" method="post"
						class="form-horizontal" enctype="multipart/form-data" role="form"
						...
						<div class="form-group">
							<label class="col-lg-2 control-label pd-r5">类型名称<font
								style="color: red;"></font></label>
							<div class="col-lg-10">
								<input type="text" class="form-control" id="storeroomName1"
									name="storeroomName1"> <input type="hidden"
									id="storeroomId1" name="storeroomId1">
							</div>
						</div>
						<div class="form-group">
							<div class="col-lg-offset-2 col-lg-10">
	...
	<form action="${appRoot}/storeroom/del" method="post"
	...
	<script type="text/javascript">
		//添加提交
		function submitData() {
			var storeroomName = $("#storeroomName").val();
			if (storeroomName == '' || storeroomName == undefined) {
		...
		function submitUpdateData() {
			var storeroomName = $("#storeroomName1").val();
			if (storeroomName == '' || storeroomName == undefined) {
				windowShow("类型名称不允许为空！", "");
				return;
			}
