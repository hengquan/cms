...
<script type="text/javascript">
	...
	function doIssue(){
	    //window.location.href="<%=request.getContextPath() %>/article/analysis.ky?articleType=C_00001";
...
<style type="text/css">
	...
	<div data-am-widget="navbar" class="am-navbar am-cf wxmp-logo" id="">
		<ul class="am-navbar-nav am-cf am-avg-sm-4">
			<li>
				<a class="wxmp-b" href="javascript:home_cust()" style="color:#10a0ea;"> <span class="am-icon-home"></span> <span class="am-navbar-label">首页</span>
				</a>
			</li>
			<li>
				<a class="wxmp-b" href="javascript:doIssue()"> <span class="am-icon-comment"></span> <span class="am-navbar-label">发布</span>
				</a>
			</li>
			<li>
