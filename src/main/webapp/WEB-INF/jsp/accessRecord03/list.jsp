...
<body>
		...
		<section id="main-content">
			<section class="wrapper">
				...
				<div class="row">
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">成交记录审核</header>
								<form action="${appRoot}/accessRecord/knockdownRecord" method="post" id="selectCheckMessage">
	...
	<form action="${appRoot}/accessRecord/knockdownRecordDel" method="post" id="deleForm" name="deleForm">
